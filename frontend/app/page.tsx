...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
      {/* Navigation */}
      <nav className="border-b border-gray-800 backdrop-blur-sm bg-black/50 fixed w-full z-50">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex justify-center">
            <Link 
              href="/login"
              className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-lg font-semibold transition flex items-center justify-center space-x-2"
            >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700 rounded-2xl hover:border-green-500/50 transition group">
            ...
            <div className="p-8 bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700 rounded-2xl hover:border-purple-500/50 transition group">
            ...
            <div className="p-8 bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700 rounded-2xl hover:border-orange-500/50 transition group">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12">
            ...
            <Link 
              href="/login"
              className="inline-flex items-center space-x-2 px-8 py-4 bg-white text-blue-600 rounded-lg text-lg font-semibold hover:bg-gray-100 transition"
            >
