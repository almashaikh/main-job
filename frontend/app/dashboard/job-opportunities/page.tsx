          ...
          {loading && jobs.length === 0 ? (
            ...
            <div className="space-y-4">
              {jobs.map((job, index) => (
                <div 
                  key={`${job.id}-${index}`} 
                  className="bg-[#2a2a2a] rounded-lg p-6 border border-gray-700 hover:border-blue-500/50 hover:shadow-lg transition-all duration-300"
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-white mb-2 job-title-hover hover:text-blue-400 cursor-pointer transition-colors">
                        {job.title}
                      </h3>
                    ...
                    <div className="text-right flex flex-col items-end space-y-2">
                      <a
                        ...
                        className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-md transition-all duration-200 flex items-center space-x-2 no-underline hover:shadow-lg hover:shadow-blue-600/50 hover-lift"
                        onClick={(e) => {
                      ...
                      {job.category?.label && (
                        <span className="px-2 py-1 bg-blue-600/20 text-blue-400 text-xs rounded badge-pulse">
                          IT Jobs
                        </span>
                      )}
                    </div>
              ...
              {jobs.length > 0 && jobs.length < totalJobs && (
                <div className="text-center pt-6 animate-slide-up">
                  <button
                    ...
                    disabled={loading}
                    className="px-8 py-3 bg-[#2a2a2a] hover:bg-[#3a3a3a] disabled:bg-[#2a2a2a] text-white rounded-md transition-all duration-200 flex items-center space-x-2 mx-auto border border-gray-700 hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-600/30 hover-lift"
                  >
                    {loading ? (
                      <>
